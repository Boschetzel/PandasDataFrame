...
# Form implementation generated from reading ui file 'rename_column.ui'
#
...
class Ui_df_operations_window(object):
    def setupUi(self, df_operations_window):
        ...
        self.apply_btn = QtWidgets.QPushButton(df_operations_window)
    ...
    def retranslateUi(self, df_operations_window):
        ...
        self.label.setText(_translate("df_operations_window", "Enter old column name"))
        self.apply_btn.setText(_translate("df_operations_window", "Apply"))
        self.label_2.setText(_translate("df_operations_window", "Enter new column name"))
